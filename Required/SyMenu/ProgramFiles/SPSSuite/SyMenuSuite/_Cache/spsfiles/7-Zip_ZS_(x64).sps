...
<SPSSchema xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://spsconsortium.net/schema/SPS.xsd">
  <ProgramName>7-Zip ZS (x64)</ProgramName>
...
A LZMA2 compression algorithm, 20% to 100% faster than normal LZMA2 at levels 5 and above, but with a slightly lower compression ratio. It uses a parallel buffered radix matchfinder and some optimizations from Zstandard. The codec uses much less additional memory per thread than standard LZMA2.</Description>
  ...
  <MainExeNames>
    <Exe>
      ...
      <ExeName>7-Zip ZS (x64)</ExeName>
    </Exe>
  </MainExeNames>
  <ScriptAfterInstall>DelFile Uninstall.exe</ScriptAfterInstall>
  <CleanUpdate>false</CleanUpdate>
  <BuiltInUpdater>false</BuiltInUpdater>
  <DownloadUrl>https://github.com/mcmilk/7-Zip-zstd/releases/download/v22.01-v1.5.5-R3/7z22.01-zstd-x64.exe</DownloadUrl>
  <DownloadSizeKb>2910</DownloadSizeKb>
...
Thanks to and original SPS submitted by: mimic</Note>
  ...
  <VirusTotalResult>
    <Permalink>https://www.virustotal.com/gui/file/d542d78397bbed8e77c221f36cad461a0d83f1263b993a7048e81df40f403fb8/detection/f-d542d78397bbed8e77c221f36cad461a0d83f1263b993a7048e81df40f403fb8-1687684237</Permalink>
    <DetectionRatio>1/71</DetectionRatio>
  </VirusTotalResult>
</SPSSchema>